...
class Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        this.props.postFeedback(values.firstName, values.lastName, values.telNum, values.email, values.agree, values.contactType, values.message)
            .then(feedback =>{
                console.log("Posted Feedback: " + JSON.stringify(feedback));
                    ...
                    <div className={'col-12 col-md-9'}>
                        <Form model={'feedback'} onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className={'form-group'}>
                                ...
                                <Col md={10}><Control.text model={".firstName"} id="firstName" name="firstName"
                            ...
                            <Row className={'form-group'}>
                                ...
                                <Col md={10}><Control.text model={".lastName"} id="lastName" name="lastName"
                            ...
                            <Row className={'form-group'}>
                                ...
                                <Col md={10}><Control.text model={".telNum"} id="telNum" name="telNum"
                                                           className={"form-control"}
                                                           placeholder='Telephone Number' validators={{
                            ...
                            <Row className={'form-group'}>
                                ...
                                <Col md={10}><Control.text model={".email"} type='email' id="email" name="email"
                            ...
                            <Row className={'form-group'}>
                                ...
                                <Col md={10}><Control.textarea model={'.message'} id="message" name="message"
